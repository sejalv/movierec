...
How it works:
- Login/Register your account through "Sign In"
- Find a movie from the "Movies" section or use the "Search" feature
- Add review (rating &/ comment) on a movie page
- Repeat steps 2 and 3, if needed.
- Hit "Movie Suggestions" on the bar and view your recommendations (Refreshing the page provides a new list everytime).
